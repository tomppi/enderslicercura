@echo off
rem Bead-angle reference slice (feature OFF) for ground-truth outline comparison.
rem Usage: _bead_ref_test.bat <model.stl> <out.gcode> <log.txt>
