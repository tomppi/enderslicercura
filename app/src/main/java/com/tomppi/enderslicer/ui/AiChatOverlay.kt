 ...
 * it. Kept deliberately to a single field: the harness hands over its own
 * credentials from `auth.json`, so there is no token to find and paste.
 */
        ...
        Card(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Column(
                    ...
                    if (setup != null) {
                        Text(
                            text = "Point this at your harness, for example " +
