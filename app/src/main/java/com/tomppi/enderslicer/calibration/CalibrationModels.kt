...
enum class CalibrationTestType(
    ...
    PRESSURE_ADVANCE(
        ...
        8,
        "The isolated-post retraction model is reused while Marlin Linear Advance K changes by section, exposing restart blobs, pressure lag and stringing without generated supports.",
        setOf(
            CalibrationModelFeature.SUPPORT_FREE,
    ...
    JUNCTION_DEVIATION(
        ...
        8,
        "The speed-test star is reused while Marlin junction deviation changes by section, exposing corner rounding, ringing and direction-change behavior without generated supports.",
        setOf(
            CalibrationModelFeature.SUPPORT_FREE,
            CalibrationModelFeature.SHARP_CORNERS,
            CalibrationModelFeature.DIRECTION_CHANGES,
