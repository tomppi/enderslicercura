...
enum class CalibrationTestType(
    ...
    PRESSURE_ADVANCE(
        ...
        8,
        "A compact six-point sharp-corner tower repeatedly accelerates and decelerates extrusion so Marlin Linear Advance K can be compared without generated supports.",
        setOf(
            CalibrationModelFeature.SUPPORT_FREE,
            CalibrationModelFeature.SHARP_CORNERS,
            CalibrationModelFeature.DIRECTION_CHANGES,
            CalibrationModelFeature.SPEED_TRANSITIONS,
            CalibrationModelFeature.TALL_WALLS,
        ),
    ),
    FAN(
